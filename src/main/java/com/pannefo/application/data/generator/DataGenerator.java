package com.pannefo.application.data.generator;

import com.vaadin.flow.spring.annotation.SpringComponent;

import com.pannefo.application.data.service.SamplePersonRepository;
import com.pannefo.application.data.entity.SamplePerson;
import com.pannefo.application.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2021, 10, 26, 0, 0, 0));
